/* ==================== GLOBAL UI INIT ==================== */
const DISCORD_LOGO_URL = 'https://image2url.com/r2/default/images/1774038361730-2380a2c7-1466-4281-86a1-ed92293a0068.png';
const APPLICATIONS_API_BASE = 'https://script.google.com/macros/s/AKfycbwVIhqJ7C3PMaQ2BsWvW8PaWgpQl-DZ5eHrp0ERcUx5WwsZ7rISeSGf7kfE02TtcReb/exec';
...
const THEME_OPTIONS = [
  { value: 'default', label: 'Midnight Aeroz' },
  ...
  { value: 'abyss', label: 'Abyss Blue' },
  { value: 'glacier', label: 'Glacier White' },
  { value: 'neon', label: 'Neon Circuit' },
  { value: 'mono', label: 'Monochrome Ice' }
];
...
const initFooterYear = () => {
  document.querySelectorAll('footer p').forEach((line) => {
    if (/©\s*Team Aeroz/i.test(line.textContent || '')) {
      line.textContent = `© Team Aeroz ${new Date().getFullYear()} — All rights reserved`;
    }
  });
};
